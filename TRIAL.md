...
**X(Twitter)で [@kiyoka](https://x.com/kiyoka) までDMでご連絡いただくだけで、Sumibiを7日間完全無料でお試しいただけるLLMアクセスキーをプレゼント！**
**お気軽にご連絡ください。**
...
- Amazon Bedrockを利用しているためBedrockのスロットリング制限で「!!HTTPエラーが発生しました!!」というエラーが出ることがあります。
